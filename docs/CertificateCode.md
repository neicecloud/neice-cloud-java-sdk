...
|**token** | **String** | 请求鉴权令牌 |  [optional] |
|**udid** | **String** | 绑定设备的UDID，兑换时绑定 |  [optional] |
|**enable** | **Boolean** | 证书网侧可用状态，与AAS禁用字段互为反义 |  [optional] |
|**black** | **Boolean** | 是否拉黑 |  [optional] |
|**deleted** | **Boolean** | 证书网侧软删除标记 |  [optional] |
|**disabled** | **Boolean** | AAS侧禁用状态，与证书网可用字段互为反义 |  [optional] |
