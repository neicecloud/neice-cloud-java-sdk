...
import cloud.neice.auth.Authentication;
import cloud.neice.auth.HttpBasicAuth;
import cloud.neice.auth.HttpBearerAuth;
import cloud.neice.auth.ApiKeyAuth;
import cloud.neice.auth.OAuth;
import cloud.neice.auth.RetryingOAuth;
import cloud.neice.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://neice.cloud";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://neice.cloud
     ...
     * @return a {@link cloud.neice.ApiClient} object
     */
    ...
    */
     ...
     * @throws cloud.neice.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws cloud.neice.ApiException If fail to serialize the given object
     */
     ...
     * @throws cloud.neice.ApiException If fail to read file content from response and write to disk
     ...
     * @throws cloud.neice.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws cloud.neice.ApiException If the response has an unsuccessful status code or
     ...
     * @throws cloud.neice.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws cloud.neice.ApiException If fails to update the parameters
     */
     ...
     * @throws cloud.neice.ApiException If fail to serialize the request body object into a string
     */
