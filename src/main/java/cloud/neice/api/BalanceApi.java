...
public class BalanceApi {
  ...
  public ResponseOfBalance getBalance() throws ApiException {
    ApiResponse<ResponseOfBalance> localVarResponse = getBalanceWithHttpInfo();
  ...
  public ApiResponse<ResponseOfBalance> getBalanceWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBalanceRequestBuilder();
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBalance", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<ResponseOfBalance>(
        ...
        return new ApiResponse<ResponseOfBalance>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ResponseOfBalance>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getBalanceRequestBuilder() throws ApiException {
