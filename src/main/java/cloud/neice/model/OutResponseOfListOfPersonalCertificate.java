...
public class OutResponseOfListOfPersonalCertificate {
  ...
  **/
  ...
  public OutResponseOfListOfPersonalCertificate data(List<PersonalCertificate> data) {
    
    this.data = data;
    return this;
  }

  public OutResponseOfListOfPersonalCertificate addDataItem(PersonalCertificate dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public OutResponseOfListOfPersonalCertificate msg(String msg) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class OutResponseOfListOfPersonalCertificate {\n");
