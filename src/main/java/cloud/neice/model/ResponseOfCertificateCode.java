 ...
 */
@JsonPropertyOrder({
  ResponseOfCertificateCode.JSON_PROPERTY_ACTION,
  ResponseOfCertificateCode.JSON_PROPERTY_ALGORITHM,
  ResponseOfCertificateCode.JSON_PROPERTY_CIPHERTEXT,
  ResponseOfCertificateCode.JSON_PROPERTY_CODE,
  ResponseOfCertificateCode.JSON_PROPERTY_DATA,
  ResponseOfCertificateCode.JSON_PROPERTY_ERROR,
  ResponseOfCertificateCode.JSON_PROPERTY_MSG,
  ResponseOfCertificateCode.JSON_PROPERTY_RESULT,
  ResponseOfCertificateCode.JSON_PROPERTY_SESSION,
  ResponseOfCertificateCode.JSON_PROPERTY_SUCCESS
})
...
public class ResponseOfCertificateCode {
  ...
  /**
   * Return true if this ResponseOfCertificateCode object is equal to o.
   */
  @Override
