...
public class ResponseOfCertificateCode {
  ...
  public ResponseOfCertificateCode() {
  }

  public ResponseOfCertificateCode action(@jakarta.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ResponseOfCertificateCode algorithm(@jakarta.annotation.Nullable String algorithm) {
  ...
  public ResponseOfCertificateCode ciphertext(@jakarta.annotation.Nullable String ciphertext) {
  ...
  public ResponseOfCertificateCode code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseOfCertificateCode data(@jakarta.annotation.Nullable CertificateCode data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@jakarta.annotation.Nullable CertificateCode data) {
    this.data = data;
  }


  public ResponseOfCertificateCode error(@jakarta.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseOfCertificateCode msg(@jakarta.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public ResponseOfCertificateCode result(@jakarta.annotation.Nullable Result result) {
    this.result = result;
    return this;
  }
  ...
  public ResponseOfCertificateCode session(@jakarta.annotation.Nullable String session) {
  ...
  public ResponseOfCertificateCode success(@jakarta.annotation.Nullable Boolean success) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseOfCertificateCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseOfCertificateCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseOfCertificateCode is not found in the empty JSON string", ResponseOfCertificateCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseOfCertificateCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseOfCertificateCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseOfCertificateCode.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CertificateCode.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseOfCertificateCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseOfCertificateCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseOfCertificateCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseOfCertificateCode.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseOfCertificateCode>() {
           @Override
           public void write(JsonWriter out, ResponseOfCertificateCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseOfCertificateCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseOfCertificateCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseOfCertificateCode
   * @throws IOException if the JSON string is invalid with respect to ResponseOfCertificateCode
   */
  public static ResponseOfCertificateCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseOfCertificateCode.class);
  }

  /**
   * Convert an instance of ResponseOfCertificateCode to an JSON string
   *
   * @return JSON string
   */
