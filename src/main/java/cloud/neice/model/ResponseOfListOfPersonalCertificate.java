...
public class ResponseOfListOfPersonalCertificate {
  ...
  **/
  ...
  public ResponseOfListOfPersonalCertificate code(Integer code) {
  ...
  **/
  ...
  public ResponseOfListOfPersonalCertificate data(List<PersonalCertificate> data) {
  ...
  public ResponseOfListOfPersonalCertificate addDataItem(PersonalCertificate dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<PersonalCertificate>();
    }
  ...
  **/
  ...
  public ResponseOfListOfPersonalCertificate error(ErrorEnum error) {
  ...
  **/
  ...
  public ResponseOfListOfPersonalCertificate msg(String msg) {
  ...
  **/
  ...
  public ResponseOfListOfPersonalCertificate result(Result result) {
