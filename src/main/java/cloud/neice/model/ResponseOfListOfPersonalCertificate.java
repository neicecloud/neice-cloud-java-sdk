...
public class ResponseOfListOfPersonalCertificate {
  ...
  @jakarta.annotation.Nullable
  private List<PersonalCertificate> data = new ArrayList<>();
  ...
  public ResponseOfListOfPersonalCertificate() {
  }

  public ResponseOfListOfPersonalCertificate action(@jakarta.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ResponseOfListOfPersonalCertificate algorithm(@jakarta.annotation.Nullable String algorithm) {
  ...
  public ResponseOfListOfPersonalCertificate ciphertext(@jakarta.annotation.Nullable String ciphertext) {
  ...
  public ResponseOfListOfPersonalCertificate code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseOfListOfPersonalCertificate data(@jakarta.annotation.Nullable List<PersonalCertificate> data) {
    this.data = data;
    return this;
  }

  public ResponseOfListOfPersonalCertificate addDataItem(PersonalCertificate dataItem) {
    if (this.data == null) {
  ...
  public void setData(@jakarta.annotation.Nullable List<PersonalCertificate> data) {
    this.data = data;
  }


  public ResponseOfListOfPersonalCertificate error(@jakarta.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseOfListOfPersonalCertificate msg(@jakarta.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public ResponseOfListOfPersonalCertificate result(@jakarta.annotation.Nullable Result result) {
    this.result = result;
    return this;
  }
  ...
  public ResponseOfListOfPersonalCertificate session(@jakarta.annotation.Nullable String session) {
  ...
  public ResponseOfListOfPersonalCertificate success(@jakarta.annotation.Nullable Boolean success) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseOfListOfPersonalCertificate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseOfListOfPersonalCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseOfListOfPersonalCertificate is not found in the empty JSON string", ResponseOfListOfPersonalCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseOfListOfPersonalCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseOfListOfPersonalCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseOfListOfPersonalCertificate.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PersonalCertificate.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseOfListOfPersonalCertificate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseOfListOfPersonalCertificate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseOfListOfPersonalCertificate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseOfListOfPersonalCertificate.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseOfListOfPersonalCertificate>() {
           @Override
           public void write(JsonWriter out, ResponseOfListOfPersonalCertificate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseOfListOfPersonalCertificate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseOfListOfPersonalCertificate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseOfListOfPersonalCertificate
   * @throws IOException if the JSON string is invalid with respect to ResponseOfListOfPersonalCertificate
   */
  public static ResponseOfListOfPersonalCertificate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseOfListOfPersonalCertificate.class);
  }

  /**
   * Convert an instance of ResponseOfListOfPersonalCertificate to an JSON string
   *
   * @return JSON string
   */
