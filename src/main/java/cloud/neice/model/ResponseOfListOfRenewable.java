...
public class ResponseOfListOfRenewable {
  ...
  @jakarta.annotation.Nullable
  private List<Renewable> data = new ArrayList<>();
  ...
  public ResponseOfListOfRenewable() {
  }

  public ResponseOfListOfRenewable action(@jakarta.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ResponseOfListOfRenewable algorithm(@jakarta.annotation.Nullable String algorithm) {
  ...
  public ResponseOfListOfRenewable ciphertext(@jakarta.annotation.Nullable String ciphertext) {
  ...
  public ResponseOfListOfRenewable code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseOfListOfRenewable data(@jakarta.annotation.Nullable List<Renewable> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@jakarta.annotation.Nullable List<Renewable> data) {
    this.data = data;
  }


  public ResponseOfListOfRenewable error(@jakarta.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseOfListOfRenewable msg(@jakarta.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public ResponseOfListOfRenewable result(@jakarta.annotation.Nullable Result result) {
    this.result = result;
    return this;
  }
  ...
  public ResponseOfListOfRenewable session(@jakarta.annotation.Nullable String session) {
  ...
  public ResponseOfListOfRenewable success(@jakarta.annotation.Nullable Boolean success) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseOfListOfRenewable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseOfListOfRenewable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseOfListOfRenewable is not found in the empty JSON string", ResponseOfListOfRenewable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseOfListOfRenewable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseOfListOfRenewable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseOfListOfRenewable.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Renewable.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseOfListOfRenewable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseOfListOfRenewable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseOfListOfRenewable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseOfListOfRenewable.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseOfListOfRenewable>() {
           @Override
           public void write(JsonWriter out, ResponseOfListOfRenewable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseOfListOfRenewable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseOfListOfRenewable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseOfListOfRenewable
   * @throws IOException if the JSON string is invalid with respect to ResponseOfListOfRenewable
   */
  public static ResponseOfListOfRenewable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseOfListOfRenewable.class);
  }

  /**
   * Convert an instance of ResponseOfListOfRenewable to an JSON string
   *
   * @return JSON string
   */
