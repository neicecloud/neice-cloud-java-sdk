 ...
 */
@JsonPropertyOrder({
  ResponseOfListOfRenewable.JSON_PROPERTY_ACTION,
  ResponseOfListOfRenewable.JSON_PROPERTY_ALGORITHM,
  ResponseOfListOfRenewable.JSON_PROPERTY_CIPHERTEXT,
  ResponseOfListOfRenewable.JSON_PROPERTY_CODE,
  ResponseOfListOfRenewable.JSON_PROPERTY_DATA,
  ResponseOfListOfRenewable.JSON_PROPERTY_ERROR,
  ResponseOfListOfRenewable.JSON_PROPERTY_MSG,
  ResponseOfListOfRenewable.JSON_PROPERTY_RESULT,
  ResponseOfListOfRenewable.JSON_PROPERTY_SESSION,
  ResponseOfListOfRenewable.JSON_PROPERTY_SUCCESS
})
...
public class ResponseOfListOfRenewable {
  ...
  /**
   * Return true if this ResponseOfListOfRenewable object is equal to o.
   */
  @Override
