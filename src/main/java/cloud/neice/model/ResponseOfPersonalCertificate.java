...
public class ResponseOfPersonalCertificate {
  /**
   * Gets or Sets action
   */
  ...
  public ResponseOfPersonalCertificate() {
  }

  public ResponseOfPersonalCertificate action(@jakarta.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ResponseOfPersonalCertificate algorithm(@jakarta.annotation.Nullable String algorithm) {
  ...
  public ResponseOfPersonalCertificate ciphertext(@jakarta.annotation.Nullable String ciphertext) {
  ...
  public ResponseOfPersonalCertificate code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseOfPersonalCertificate data(@jakarta.annotation.Nullable PersonalCertificate data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@jakarta.annotation.Nullable PersonalCertificate data) {
    this.data = data;
  }


  public ResponseOfPersonalCertificate error(@jakarta.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseOfPersonalCertificate msg(@jakarta.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public ResponseOfPersonalCertificate result(@jakarta.annotation.Nullable Result result) {
    this.result = result;
    return this;
  }
  ...
  public ResponseOfPersonalCertificate session(@jakarta.annotation.Nullable String session) {
  ...
  public ResponseOfPersonalCertificate success(@jakarta.annotation.Nullable Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    ResponseOfPersonalCertificate responseOfPersonalCertificate = (ResponseOfPersonalCertificate) o;
    return Objects.equals(this.action, responseOfPersonalCertificate.action) &&
        Objects.equals(this.algorithm, responseOfPersonalCertificate.algorithm) &&
        Objects.equals(this.ciphertext, responseOfPersonalCertificate.ciphertext) &&
        Objects.equals(this.code, responseOfPersonalCertificate.code) &&
        Objects.equals(this.data, responseOfPersonalCertificate.data) &&
        Objects.equals(this.error, responseOfPersonalCertificate.error) &&
        Objects.equals(this.msg, responseOfPersonalCertificate.msg) &&
        Objects.equals(this.result, responseOfPersonalCertificate.result) &&
        Objects.equals(this.session, responseOfPersonalCertificate.session) &&
        Objects.equals(this.success, responseOfPersonalCertificate.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseOfPersonalCertificate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseOfPersonalCertificate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseOfPersonalCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseOfPersonalCertificate is not found in the empty JSON string", ResponseOfPersonalCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseOfPersonalCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseOfPersonalCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseOfPersonalCertificate.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PersonalCertificate.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseOfPersonalCertificate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseOfPersonalCertificate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseOfPersonalCertificate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseOfPersonalCertificate.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseOfPersonalCertificate>() {
           @Override
           public void write(JsonWriter out, ResponseOfPersonalCertificate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseOfPersonalCertificate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseOfPersonalCertificate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseOfPersonalCertificate
   * @throws IOException if the JSON string is invalid with respect to ResponseOfPersonalCertificate
   */
  public static ResponseOfPersonalCertificate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseOfPersonalCertificate.class);
  }

  /**
   * Convert an instance of ResponseOfPersonalCertificate to an JSON string
   *
   * @return JSON string
   */
