 ...
 */
@JsonPropertyOrder({
  ResponseOfStatus.JSON_PROPERTY_ACTION,
  ResponseOfStatus.JSON_PROPERTY_ALGORITHM,
  ResponseOfStatus.JSON_PROPERTY_CIPHERTEXT,
  ResponseOfStatus.JSON_PROPERTY_CODE,
  ResponseOfStatus.JSON_PROPERTY_DATA,
  ResponseOfStatus.JSON_PROPERTY_ERROR,
  ResponseOfStatus.JSON_PROPERTY_MSG,
  ResponseOfStatus.JSON_PROPERTY_RESULT,
  ResponseOfStatus.JSON_PROPERTY_SESSION,
  ResponseOfStatus.JSON_PROPERTY_SUCCESS
})
...
public class ResponseOfStatus {
  ...
  /**
   * Return true if this ResponseOfStatus object is equal to o.
   */
  @Override
