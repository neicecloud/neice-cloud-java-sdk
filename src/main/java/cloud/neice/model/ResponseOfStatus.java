...
public class ResponseOfStatus {
  ...
  public ResponseOfStatus() {
  }

  public ResponseOfStatus action(@jakarta.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ResponseOfStatus algorithm(@jakarta.annotation.Nullable String algorithm) {
  ...
  public ResponseOfStatus ciphertext(@jakarta.annotation.Nullable String ciphertext) {
  ...
  public ResponseOfStatus code(@jakarta.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseOfStatus data(@jakarta.annotation.Nullable Status data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@jakarta.annotation.Nullable Status data) {
    this.data = data;
  }


  public ResponseOfStatus error(@jakarta.annotation.Nullable ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseOfStatus msg(@jakarta.annotation.Nullable String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public ResponseOfStatus result(@jakarta.annotation.Nullable Result result) {
    this.result = result;
    return this;
  }
  ...
  public ResponseOfStatus session(@jakarta.annotation.Nullable String session) {
  ...
  public ResponseOfStatus success(@jakarta.annotation.Nullable Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    ResponseOfStatus responseOfStatus = (ResponseOfStatus) o;
    return Objects.equals(this.action, responseOfStatus.action) &&
        Objects.equals(this.algorithm, responseOfStatus.algorithm) &&
        Objects.equals(this.ciphertext, responseOfStatus.ciphertext) &&
        Objects.equals(this.code, responseOfStatus.code) &&
        Objects.equals(this.data, responseOfStatus.data) &&
        Objects.equals(this.error, responseOfStatus.error) &&
        Objects.equals(this.msg, responseOfStatus.msg) &&
        Objects.equals(this.result, responseOfStatus.result) &&
        Objects.equals(this.session, responseOfStatus.session) &&
        Objects.equals(this.success, responseOfStatus.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseOfStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseOfStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseOfStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseOfStatus is not found in the empty JSON string", ResponseOfStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseOfStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseOfStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseOfStatus.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Status.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseOfStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseOfStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseOfStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseOfStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseOfStatus>() {
           @Override
           public void write(JsonWriter out, ResponseOfStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseOfStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseOfStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseOfStatus
   * @throws IOException if the JSON string is invalid with respect to ResponseOfStatus
   */
  public static ResponseOfStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseOfStatus.class);
  }

  /**
   * Convert an instance of ResponseOfStatus to an JSON string
   *
   * @return JSON string
   */
